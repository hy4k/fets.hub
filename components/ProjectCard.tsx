  ...
  return (
    ...
    >
      ...
      <img 
        ...
        className={`w-full h-full object-cover rounded-md transition-all duration-700 ease-in-out ${isHovered ? 'opacity-0' : 'grayscale group-hover:grayscale-0 brightness-75 group-hover:brightness-100'}`}
      />

      {/* Hover Card (Pop-out effect) */}
      <div 
        className={`
          absolute top-0 left-0 w-full bg-[#141414] rounded-md overflow-hidden transition-all duration-700 ease-in-out origin-center transform shadow-black/80 border border-transparent
          ${isHovered ? 'scale-110 -translate-y-6 opacity-100 z-50 shadow-2xl border-white/10' : 'opacity-0 pointer-events-none scale-100 z-10'}
        `}
        style={isHovered ? { 
      ...
      >
        ...
        <div className="p-4 flex flex-col gap-3 bg-[#141414] relative">
          ...
          {/* Action Buttons */}
          <div className="flex items-center justify-between mb-1 relative z-10 animate-in fade-in duration-500">
          ...
          {/* Metadata */}
          <div className="relative z-10 animate-in slide-in-from-bottom-2 duration-500 delay-75">
