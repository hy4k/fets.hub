...
const App = () => {
  ...
  const bannerImages = [
    '/images/2025-10-03.webp',
    '/images/3.png',
    'https://picsum.photos/seed/fets-live/1920/1080',
    'https://picsum.photos/seed/fets-cash/1920/1080',
    'https://picsum.photos/seed/fets-team/1920/1080',
    'https://picsum.photos/seed/fets-cloud/1920/1080',
  ];
      ...
      >
        <div className="px-4 md:px-12 py-4 flex items-center justify-between">
          <div className="flex items-center gap-10">
            ...
            >
               <h1 className="font-['Orbitron'] text-4xl md:text-6xl font-black tracking-widest drop-shadow-lg bg-gradient-to-r from-[var(--primary-color)] to-purple-600 bg-clip-text text-transparent">
                FETS HUB
               </h1>
            </div>
            
            {/* Menu Links (Hidden on mobile) */}
            <ul className="hidden lg:flex gap-8 text-lg font-bold tracking-widest font-['Audiowide']">
              
              {/* Resources Dropdown */}
              <li 
                className={`relative group ${getLinkClass('Resources')} flex items-center gap-2 uppercase`} 
              ...
              {/* FETS Apps Dropdown */}
              <li 
                className={`relative group ${getLinkClass('FETS Apps')} flex items-center gap-2 uppercase`} 
              ...
              {/* SOP Dropdown (NEW) */}
              <li 
                className={`relative group ${getLinkClass('SOP')} flex items-center gap-2 uppercase`} 
            ...
            <div className="relative h-[70vh] md:h-[90vh] w-full bg-black animate-in fade-in duration-1000 border-b border-white/5">
              ...
              >
                <img 
                  ...
                  onError={(e) => { e.currentTarget.src = featuredImage; }}
                />
